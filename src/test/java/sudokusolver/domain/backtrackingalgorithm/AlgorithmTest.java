...
public class AlgorithmTest {
    private Algorithm backtracking = new Algorithm();

    @Test
    public void sudokuWithSingleSolution() {
        ...
        int[][] solution = backtracking.solve(sudoku).get(0);
        
        assertTrue(Arrays.deepEquals(solution, solvedSudoku));
